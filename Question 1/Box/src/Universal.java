public class Universal implements Calculation{
    ...
    Universal(int length, int breadth, int depth, Flute flute, String partition, int gSM, char fluteType, String StringType, Stiching stiching){ //Constructor
        this.length = length;
        this.depth = depth;
        this.flute = flute;
