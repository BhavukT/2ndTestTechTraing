public class ReverseTuckIn implements Calculation{
    private int length;
    private int breadth;
    private int depth;
    private int area;
    ...
    ReverseTuckIn(int length, int breadth, int depth, String partition, int gSM, char fluteType, String StringType, Stiching stiching){
        this.length = length;
        this.depth = depth;
